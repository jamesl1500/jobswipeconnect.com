                ...
                <div class="jobs-page-applicants-navigation">
                    ...
                    <div class="jobs-page-applicants-navigation-inner">
                        <ul>
                            ...
                            <li class="active"><a href="{{ route('jobs.show.applicants.interviewing', $job->id) }}">Interviewing</a></li>
                ...
                <div class="jobs-page-content-box">
                    ...
                    @else
                        <div class="no-applicants">
                            ...
                            <p>There are currently no applicants being interviewed for this job!</p>
                        </div>
                    @endif
                </div>
            </div>
