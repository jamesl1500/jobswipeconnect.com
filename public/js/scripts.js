 ...
 * Pusher
 */
var pusher_app_key = "de061cb1e3f108dbecbe";
...
if (conversation) {
  ...
  window.Echo["private"]('conversation.' + conversation.value).listen('MessagePosted', function (e) {
    console.log(e);
    // Append new message
   ...
   */
  var sendMessage = function sendMessage(id, content) {
  ...
  document.querySelector('#message-form').addEventListener('submit', function (event) {
    ...
    var conversation_id = document.querySelector('#conversation_uid').value;
    var content = document.querySelector('#message-textarea').value;
